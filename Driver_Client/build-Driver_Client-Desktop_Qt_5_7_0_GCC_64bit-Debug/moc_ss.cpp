...
const QMetaObject ss::staticMetaObject = {
    { &QTabWidget::staticMetaObject, qt_meta_stringdata_ss.data,
      qt_meta_data_ss,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ss::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ss.stringdata0))
        return static_cast<void*>(const_cast< ss*>(this));
